...
function isLoggedIn() {
    ...
    if (!isset($_SESSION['fingerprint']) || !is_string($_SESSION['fingerprint']) || !hash_equals($_SESSION['fingerprint'], $expectedFingerprint)) {
        session_unset();
        session_destroy();
        return false;
    }
...
function attemptLogin($username, $password) {
    ...
    if ($userExists && $passwordValid) {
        ...
        // Regenerate CSRF token to prevent CSRF token fixation (Login CSRF)
